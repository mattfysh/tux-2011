...
(function(){tux.accounts.AccountsApp=Backbone.View.extend({id:"accounts",initialize:function(){var a;$("<ul>").appendTo(this.el);_(this).bindAll("addAccountToList","displayAccount");this.list=new tux.accounts.AccountList;a=new tux.accounts.TotalView({collection:this.list});this.$("ul").append(a.el);a=new tux.accounts.AccountForm;a.bind("newaccount",this.addAccountToList);$(this.el).append(a.el);this.list.each(this.displayAccount);this.list.bind("add",this.displayAccount)},addAccountToList:function(a){this.list.create(a)},
displayAccount:function(a){a=new tux.accounts.AccountView({model:a});this.$("ul li.total").before(a.el)}})})();namespace("tux.accounts");
(function(){tux.accounts.AccountView=Backbone.View.extend({tagName:"li",initialize:function(){_(this).bindAll("remove");this.model.bind("remove",this.remove);this.render()},events:{"click a.destroy":"destroy"},render:function(){var a=this.model.toJSON(),a=tux.accounts.accountView(a);$(this.el).empty().append(a);return this},destroy:function(a){a.preventDefault();this.model.destroy()}})})();namespace("tux.accounts");
(function(){tux.accounts.TotalView=Backbone.View.extend({tagName:"li",className:"total",initialize:function(){_(this).bindAll("render");this.collection.bind("add",this.render).bind("remove",this.render).bind("change:balance",this.render);this.render()},render:function(){var a=tux.accounts.totalView({total:this.collection.getTotal()});$(this.el).empty().append(a)}})})();namespace("tux.accounts");
tux.accounts.accountForm=function(a){var b=[];with(a||{})b.push('<form>\r\n\t<input type="text" name="name" />\r\n\t<input type="text" name="balance" />\r\n\t<input type="submit" />\r\n</form>');return b.join("")};tux.accounts.accountView=function(a){var b=[];with(a||{})b.push('<span class="name">',name,'</span><span class="balance">',format(balance),'</span><a class="destroy" href="destroy">delete</a>\r\n');return b.join("")};
tux.accounts.totalView=function(a){var b=[];with(a||{})b.push('Total<span class="total">',format(total),"</span>\r\n");return b.join("")};
